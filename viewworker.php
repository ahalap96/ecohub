    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                ...
                <h1 class="display-5">We Are Professional Workers</h1>
            </div>
            <div class="row g-5">
            <?php
                        ...
                        <div class="col-10">
                            <div class="position-relative">
                                ...
                                <h4 class="text-white"><?php echo $row['name'];?></h4>
                                    <span class="text-white"><?php echo $row['work_type'];?></span><br>
                                    <span class="text-white"><?php echo $row['mobile'];?></span><br>
                                    <?php
                                        if($row['status']=='0'){
                                     ?>
                                     <a class="btn btn-secondary" href="wrkrsapproval.php?eid=<?php echo $row['lid'];?>">pending</a>
                                    <?php

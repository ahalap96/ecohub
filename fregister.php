...
if(isset($_POST['register'])){
    ...
    $farmer="farmer";
    mysqli_query($con,"insert into login(username,password,type)values('$username','$password','$farmer')");
    $var= mysqli_insert_id($con);
 $query="INSERT INTO `farmers`(`lid`,`name`, `place`, `mobile`,`age`) VALUES ('$var','$name','$place','$mobile','$age')";
...
<div class="card-body bg-secondary">
  ...
  <div class="pt-4 pb-2">
    <h5 class="card-title text-center pb-0 fs-4">Farmer Registration</h5>
  </div>

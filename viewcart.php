...
session_start();
$id=$_SESSION['id'];
$query="select * from cart join products on cart.prod_id=products.prod_id where cart.lid='$id'";
                ...
                <div class="mb-5">
                    <div class="row g-5 mb-5">
                        ...
                        <div class="col-md-6">
                            ...
                            <h3>Rs.<?php echo $row['tprice'];?></h3>
                           <a class="btn btn-primary" href="remove.php?eid=<?php echo $row['prod_id'];?>">Remove</a>
                           <a class="btn btn-secondary" href="buy.php?eid=<?php echo $row['prod_id'];?>">Buy now</a>
                        </div>
                        <!-- <div class="col-md-6">

        ...
        <div class="container py-5">
            <div class="row justify-content-start">
                <div class="col-lg-8 text-center text-lg-start">
                    <h1 class="display-1 text-white mb-md-4">Our Farmers</h1>
                        ...
                        <div class="col-10">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    ...
                                    <span class="text-white"><?php echo $row['place'];?></span><br>
                                    <span class="text-white"><?php echo $row['mobile'];?></span><br>
                                    <span class="text-white"><?php echo $row['age'];?></span><br>

                                    <?php
                                        if($row['status']=='0'){
                                     ?>
                                     <a class="btn btn-secondary" href="approval.php?eid=<?php echo $row['lid'];?>">pending</a>
                                    <?php
                                     ...
                                     <?php
                                        if($row['status']=='1'){
                                     ?>
                                    <a class="btn btn-secondary" href="null">approved</a>
                                    <?php
                        ...
                        <div class="col-10">
                            <div class="position-relative">
                                ...
                                <div class="position-absolute start-0 bottom-0 w-100 py-3 px-4" style="background: rgba(52, 173, 84, .85);">
                                    ...
                                    <span class="text-white">Designation</span><br>
                                    <span class="text-white">Mobile</span><br>
                                    <span class="text-white">Age</span><br>

                    ...
                    <div class="col-md-6">
                        <div class="blog-item position-relative overflow-hidden">
                            ...
                            <a class="blog-overlay" href="">
                                ...
                                <span class="text-white fw-bold"><?php echo $row['prod_name'];?></span>
                                <span class="text-white fw-bold"><?php echo $row['sub_date'];?></span>
                                <span class="text-white fw-bold"><?php echo $row['Quantity'];?></span>
                            </a>
                        </div>
                        <div class="btn-action d-flex justify-content-center">
                            <?php
                                        if($row['ostatus']=='0'){
                                     ?>
                                     <a class="btn btn-secondary py-2 px-3" href="orderapproval.php?eid=<?php echo $row['order_id'];?>">ordered</a>
                                    <?php

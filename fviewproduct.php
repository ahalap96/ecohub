            ...
            <div class="owl-carousel product-carousel px-5">
                ...
                <?php
                    ...
                    <div class="product-item position-relative bg-white d-flex flex-column text-center">
                        ...
                        <h6 class="mb-3"><?php echo $row['prod_name'];?></h6>
                        ...
                        <div class="btn-action d-flex justify-content-center">
                                ...
                                <?php
                                        if($row['status']=='0'){
                                     ?>
                                     <a class="btn btn-secondary py-2 px-3" href="prdtapproval.php?eid=<?php echo $row['farm_id'];?>">pending</a>
                                    <?php
                                     ...
                                     <?php
                                        if($row['status']=='1'){
                                     ?>
                                    <a class="btn btn-secondary py-2 px-3" href="null">approved</a>
                                    <?php

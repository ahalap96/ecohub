...
$query="select * from work join workers on work.lid=workers.lid where work.work_type='decorations'";
    ...
    <div class="container-fluid py-5">
        <div class="container">
            <div class="mx-auto text-center mb-5" style="max-width: 500px;">
                ...
                <h1 class="display-5">Decorations</h1>
            </div>
            <div class="row g-5">
            <?php
                        ...
                        <div class="col-10">
                            <div class="position-relative">
                                ...
                                <h4 class="text-white"></h4>
                                    ...
                                    <span style="color:black;"><?php echo $row['count'];?></span><br>
                                   
                                     <a class="btn btn-secondary" href="https://api.whatsapp.com/send?phone=+91<?php echo $row['mobile'];?>&text='Hi'">connect me<i class="bi bi-chat-text"></i></a>
